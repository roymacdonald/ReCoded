...
void yeseulRileyBrokencircle::draw(){
    ...
    for (int j=0; j<numberOfPatterns; j+=1){
		...
		circle1= {startX+10/numberOfPatterns-speedVal*0.1, startY-40/numberOfPatterns+speedVal*0.4, 0};
		circle2= {startX+15/numberOfPatterns-speedVal*0.15, startY-35/numberOfPatterns+speedVal*0.35, 0};
		circle3= {startX-20/numberOfPatterns+speedVal*0.2, startY+20/numberOfPatterns-speedVal*0.2, 0};
		circle4= {startX, startY, 0};
